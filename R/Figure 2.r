...
### Data pre-processing, including constructing Seurat object, quality filtering, data normalization, dimension reduction, clustering, and cell type identification, was described in detail in the script Figure 1.r
