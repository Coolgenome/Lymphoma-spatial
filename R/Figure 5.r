...
T_cell_comparison_EBV_CN1 <- subset(T_cell_comparison_EBV, subset = CN_cluster == "CN1")
...
# For calculating the p values shown in Fig. 5f and 5h, DEG analysis was done between EBV+ and EBV- groups
